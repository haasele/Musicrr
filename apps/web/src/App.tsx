...
useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {isPlayerExpanded && (
        <div
          className="player-morph-shell fixed inset-0 z-[180] overflow-x-hidden overflow-y-hidden overscroll-none bg-[#0d0a12]"
          style={
            {
              "--accent-a": accentA,
              "--accent-b": accentB,
