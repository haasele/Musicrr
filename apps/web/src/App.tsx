...
useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {isPlayerExpanded && (
        <div
          className="player-morph-shell fixed inset-0 z-[180] overflow-hidden overscroll-none touch-none bg-[#0d0a12]"
          style={
            {
              "--accent-a": accentA,
              "--accent-b": accentB,
